...
avg_sub_temps <- temps_F-mean_temps_F

#Subtract 32 and multiply by 5/9ths to create a vector in Celsius

temps_celsius <- (32-avg_sub_temps)*5/9
```
...
d <- c(1, 2, 3, 4) # What type of vector? Answer: Numbers
e <- c("red", "white", "red", NA) # What type of vector? Answer: Characters
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector? Answer: Logic elements
