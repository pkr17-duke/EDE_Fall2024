...
ggplot(neonics) +
  geom_freqpoly(aes(x = Publication.Year), binwidth = 1) +  labs(title = "Number of studies conducted between 1980-2020", 
...
ggplot(neonics) + 
  geom_freqpoly(aes(x = Publication.Year, color = Test.Location)
                , binwidth = 1) +  labs(title = "Number of studies conducted between 1980-2020", 
                     x = "Publication Year", y = "Number of studies")
...
ggplot(data = litter, aes(x = litter$functionalGroup)) +
  geom_bar() + 
labs(title = "Litter by Functional Group", x = "Functional groups", y = "Count observed")
